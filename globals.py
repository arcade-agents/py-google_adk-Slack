...
"""
ENFORCE_HUMAN_CONFIRMATION = ['Slack_GetConversationMetadata', 'Slack_GetMessages', 'Slack_GetUsersInConversation', 'Slack_GetUsersInfo', 'Slack_ListConversations', 'Slack_ListUsers', 'Slack_SendMessage']